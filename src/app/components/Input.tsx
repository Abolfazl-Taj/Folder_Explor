...
const Input = ({ labelName, type, placeHolder, name, inputClass, labelClass, icon, strengthBar = false, defaultValue }: inputType) => {
    const id = useId()
        ...
        case "text":
            return <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-1 ring-1 ring-zinc-500 px-2 rounded-md focus-within:ring-blue-500 w-full">
                    ...
                    <input defaultValue={defaultValue} {...field} id={id} className={`!${inputClass} pl-2 py-1 flex-1 outline-0 `} type={"text"} placeholder={placeHolder} name={name} />
                </div>
        ...
        case "password":
            return <div className="flex flex-col gap-2">
                ...
                {strengthBar && <PasswordStrengthBar
                    ...
                    scoreWords={[
                        meta.error ? meta.error : "Very Weak",
                        "Too Weak",
                        "Decent!",
                        "Getting Better",
                        "Awesome!"
