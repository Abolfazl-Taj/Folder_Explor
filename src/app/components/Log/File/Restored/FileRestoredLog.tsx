...
const FileRestoredLog = ({data}:{data:ActivityLog}) => {
  return (
    <li className="w-full bg-blue-700/20 p-4 rounded-md shadow border border-blue-500 gap-1 flex flex-col hover:border-blue-600 hover:bg-blue-700/40">
            ...
            <p className="text-white/40 text-sm">Date {new Date(data.createdAt).toLocaleString()}</p>    </li>
  )
}

export default FileRestoredLog